...
DROP TABLE dbo.msdyn_transactioncatery;
...
DROP TABLE dbo.msdyn_orderlineresourcecatery;
...
DROP TABLE dbo.bookableresourcecateryassn;
DROP TABLE dbo.bookableresourcecatery;
