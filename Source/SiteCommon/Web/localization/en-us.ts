export const EN_US = {
    ...
    CHOOSE_SSAS_DESCRIPTION: `Power BI with Azure Analysis Services is recommended for enterprise-grade deployments for larger installations (more than 100,000 rows), to support additional analytics tools such as Excel, or to provide a finer grain of control on how data is loaded into Power BI. The Azure Analysis Services standard tier incurs an additional cost of $0.605/hr.`,
