export const EN_US = {
    ...
    AZURE_LOGIN_DIRECTORY_TEXT: `In order to connect to your Microsoft account we will need to know your Azure directory. To figure this out please refer to our `,
